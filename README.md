...
| :warning: WARNING          |
|:---------------------------|
| If you need the data to be replicated in more than one DataNode, you must modify the replication number mentioned in the **hdfs-site.xml** files into all the nodes. This number cannot be greater than the number of nodes. We're going to set it here at 2.     |
